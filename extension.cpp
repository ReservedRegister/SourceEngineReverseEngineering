...
pthread_mutex_t entityDeleteListLock;
...
bool SynergyUtils::SDK_OnLoad(char *error, size_t maxlen, bool late)
{
    ...
    pthread_mutex_init(&entityDeleteListLock, NULL);
    ...
    InsertToValuesList(played_gametags_list, new_gametag, NULL, false, true);
...
void PatchRestoring()
{
    ...
    *(uint32_t*)(patch_restore_base+1) = offset;*/
    ...
    offset = (uint32_t)SynergyUtils::getCppAddr(Hooks::GameFrameHook) - hook_game_frame_delete_list - 5;
    ...
    *(uint32_t*)(disable_response_saving) = (uint32_t)SynergyUtils::getCppAddr(Hooks::EmptyCall);
    ...
    *(uint32_t*)(disable_achievement_saving) = (uint32_t)SynergyUtils::getCppAddr(Hooks::EmptyCall);

    //Disable SOMETHING saving
    uint32_t disable_something_saving = server_srv + 0x00D7DE90;
    *(uint32_t*)(disable_something_saving) = (uint32_t)SynergyUtils::getCppAddr(Hooks::EmptyCall);

    //Disable SOMETHING saving
    uint32_t disable_something_saving_two = server_srv + 0x00C84630;
    *(uint32_t*)(disable_something_saving_two) = (uint32_t)SynergyUtils::getCppAddr(Hooks::EmptyCall);

    //Disable SOMETHING saving
    uint32_t disable_something_saving_three = server_srv + 0x00C709F0;
    *(uint32_t*)(disable_something_saving_three) = (uint32_t)SynergyUtils::getCppAddr(Hooks::EmptyCall);



    //Disable AI restoring
    uint32_t disable_ai_restoring = server_srv + 0x00C70A04;
    *(uint32_t*)(disable_ai_restoring) = (uint32_t)SynergyUtils::getCppAddr(Hooks::EmptyCall);

    //Disable Template restoring
    uint32_t disable_template_restoring = server_srv + 0x00D7DEA4;
    *(uint32_t*)(disable_template_restoring) = (uint32_t)SynergyUtils::getCppAddr(Hooks::EmptyCall);

    //Disable ResponseSystem restoring
    uint32_t disable_response_restoring = server_srv + 0x00C70724;
    *(uint32_t*)(disable_response_restoring) = (uint32_t)SynergyUtils::getCppAddr(Hooks::EmptyCall);

    //Disable Commentary restoring
    uint32_t disable_commentary_restoring = server_srv + 0x00C84644;
    *(uint32_t*)(disable_commentary_restoring) = (uint32_t)SynergyUtils::getCppAddr(Hooks::EmptyCall);
...
uint32_t CallocHook(uint32_t nitems, uint32_t size)
{
    ...
    uint32_t enlarged_size = nitems*1.115;
...
void DisablePlayerViewControl()
{
    ...
    {
        pOneArgProt pDynamicOneArgFunc = (pOneArgProt)(server_srv + 0x00B52180);
...
void EnablePlayerViewControl()
{
    ...
    while((view_control = Hooks::FindEntityByClassnameHook(CGlobalEntityList, view_control, (uint32_t)"point_viewcontrol")) != 0)
    {
        ...
        pOneArgProt pDynamicOneArgFunc = (pOneArgProt)(*(uint32_t*)((*(uint32_t*)view_control)+0x30));
...
void PatchAutosave()
{
    ...
    uint32_t offset = (uint32_t)SynergyUtils::getCppAddr(Hooks::EmptyCall) - autosave_call_five - 5;
...
void PatchDropships()
{
    ...
    *(uint32_t*)(patch_location_three) = (uint32_t)SynergyUtils::getCppAddr(Hooks::EmptyCall);
...
uint32_t SaveHookDirectMalloc(uint32_t size)
{
    ...
    InsertToValuesList(leakedResourcesSaveRestoreSystem, leak, NULL, true, true);
...
uint32_t DirectMallocHookDedicatedSrv(uint32_t arg0)
{
    ...
    Value* leak = CreateNewValue((void*)ref);
    InsertToValuesList(leakedResourcesVpkSystem, leak, NULL, true, true);
...
uint32_t VpkReloadHook(uint32_t arg0)
{
    ...
    pOneArgProt pDynamicOneArgFunc = (pOneArgProt)(VpkReloadAddr);
    return pDynamicOneArgFunc(arg0);
}
...
uint32_t CreateEntityByNameHook(uint32_t arg0, uint32_t arg1)
{
    ...
    if(strcmp((char*)arg0, "prop_vehicle_mp") == 0)
    {
        ...
        return pDynamicTwoArgFunc((uint32_t)"prop_vehicle_jeep", arg1);
    }
...
uint32_t FixManhackCrash(uint32_t arg0)
{
    ...
    if(chk > (uint32_t)0xFFFF)
    {
        ...
        pOneArgProt pDynamicOneArgFunc = (pOneArgProt)(*(uint32_t*)(chk_deref+0x64));
...
uint32_t FixTransitionCrash(uint32_t arg0, uint32_t arg1, uint32_t arg2)
{
    if(arg0 > (uint32_t)0xFFFF)
    {
        ...
        pThreeArgProt pDynamicThreeArgFunc = (pThreeArgProt)(*(uint32_t*)(arg0_deref+0x0D0));
...
{
    pOneArgProt pDynamicOneArgFunc = (pOneArgProt)(server_srv + 0x004C5950);
...
uint32_t Hooks::HunterCrashFix(uint32_t arg0)
{
    ...
    {
        //Call orig func
        pOneArgProt pDynamicOneArgFunc = (pOneArgProt)(server_srv + 0x006F6910);
        return pDynamicOneArgFunc(arg0);
    }
...
uint32_t Hooks::HunterCrashFixTwo(uint32_t arg0)
{
    ...
    {
        //Call orig func
        pOneArgProt pDynamicOneArgFunc = (pOneArgProt)(server_srv + 0x008DA5A0);
        return pDynamicOneArgFunc(arg0);
    }
...
uint32_t Hooks::PlayerloadSavedHook(uint32_t arg0, uint32_t arg1)
{
    ...
    restoring = true;
    pOneArgProt pDynamicOneArgFunc = (pOneArgProt)(server_srv + 0x00A4B8C0);
    uint32_t returnVal = pDynamicOneArgFunc(arg0);
    return returnVal;
}
...
void HookFunctionsWithCpp()
{
    ...
    HookFunctionInSharedObject(server_srv, server_srv_size, (void*)(server_srv + 0x00471320), SynergyUtils::getCppAddr(Hooks::EmptyCall));
