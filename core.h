...
extern uint32_t CreateEntityByNameAddr;
extern uint32_t SaveGameStateAddr;
extern uint32_t TransitionRestoreMainCallOrigAddr;
extern uint32_t VehicleRollermineFunctionAddr;
extern uint32_t OrigSaveCallAddr;
...
extern uint32_t origAutosaveCall;
extern uint32_t origRestoreCall;
extern uint32_t UnloadUnreferencedModelsFuncAddr;
extern uint32_t EnqueueCommandAddr;
extern uint32_t CreateEntityCallAddr;
extern uint32_t OrigManhackFuncAddr;
...
extern pTwoArgProt CreateEntityByName;
extern pThreeArgProt SaveGameState;
extern pFourArgProt pTransitionRestoreMainCall;
extern pOneArgProt pCallVehicleRollermineFunction;
extern pOneArgProt pCallOrigSaveFunction;
...
extern pThreeArgProt pOrigAutosaveCallFunc;
extern pOneArgProt UnloadUnreferencedModels;
extern pOneArgProt EnqueueCommandFunc;
extern pTwoArgProt CreateEntityCallFunc;
extern pOneArgProt OrigManhackFunc;
extern pOneArgProt pDispatchSpawnFunc;
extern pOneArgProt pActivateEntityFunc;
extern pTwoArgProt pRestoreFileCallFunc;
...
extern MallocRefList mallocAllocations;
